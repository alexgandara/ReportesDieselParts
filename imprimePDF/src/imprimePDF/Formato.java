...
public class Formato {
    ...
    public static String item(int _numero) {
        String _regreso;
    	simb = new DecimalFormatSymbols();
        simb.setDecimalSeparator('.');
        simb.setGroupingSeparator(',');
        df = new DecimalFormat("000", simb);
    ...
    public static String cadena55(String _cadena) {
        String _regreso;
        String formato = "%1$-"+"55"+"s";
        _regreso=String.format(formato,_cadena);
    	return _regreso;
