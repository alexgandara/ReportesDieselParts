...
public class email_Plus {


	public static void main(String _correo_destino, String _file_xml, String _file_pdf, String _file_respuesta, String _file_base, factura_cabecera Cabecera, factura_detalle[] Detalle, int  _lineas, String _file_zip_respuesta, factura_detalle_email[] Detalle_email, param misParam) {
...
//	      props.put("mail.smtp.socketFactory.fallback", "false");
	       ...
	       String to = _correo_destino;
	      String from = misParam.get_email_de_salida(); //  "dummy21720@gmail.com";
 	      final String username = misParam.get_email_de_salida(); // "dummy21720@gmail.com";//change accordingly
	      final String password = misParam.get_password_email_de_salida(); // "pascola21720";//change accordingly
	      Properties props = new Properties();
	      props.put("mail.smtp.auth", "true");
	      props.put("mail.smtp.starttls.enable", "true");
	      props.put("mail.smtp.host", misParam.get_smtp_server());
	      props.put("mail.smtp.port", misParam.get_smtp_port());
		...
		//&&         if (cc.length() !=0) {
		 //&&       	 message.addRecipient(Message.RecipientType.CC, new InternetAddress(
		  ...
		  //&&       	}
		         ...
		         _mensaje_html=_mensaje_html.replace("#NOMBRE_BANCO1",misParam.get_banco1());
		         _mensaje_html=_mensaje_html.replace("#BANCO1_CUENTA1",misParam.get_banco1_cuenta1());
		         _mensaje_html=_mensaje_html.replace("#BANCO1_CUENTA2",misParam.get_banco1_cuenta2());
	         
		         _mensaje_html=_mensaje_html.replace("#NOMBRE_BANCO2",misParam.get_banco2());
		         _mensaje_html=_mensaje_html.replace("#BANCO2_CUENTA1",misParam.get_banco2_cuenta1());
		         _mensaje_html=_mensaje_html.replace("#BANCO2_CUENTA2",misParam.get_banco2_cuenta2());
		         ...
		         // CODIGO CORRE
		         _mensaje_html=_mensaje_html.replace("#CORREO",misParam.get_email_de_salida());
		         
		         
		         // CODIGO NOTAS
String _notas ="Autorizado para ser emisor electrónico mediante la resolución de intendencia N° "+misParam.get_resolucion();
